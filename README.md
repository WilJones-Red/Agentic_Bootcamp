...
- **LangChain & LangGraph** - Building intelligent agent workflows
- **Model Context Protocol (MCP)** - Connecting agents to external services
...
| Week | Topic | Focus |
|------|-------|-------|
| 1 | LLM Bootcamp | Getting started with API calls and LangChain |
| 2 | Workflows & Agents | Understanding architecture patterns |
| 3 | Tools & MCP | Connecting agents to external services |
| 4 | LangSmith Diagnostics | Debugging and tracing agent behavior |
| 5 | Advanced Topics | TBD |
...
git clone https://github.com/your-username/AI_Boot_Camp.git
cd AI_Boot_Camp
